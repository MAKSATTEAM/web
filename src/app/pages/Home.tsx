    ...
    <div className="pt-20">
      ...
      <section className="relative min-h-screen flex items-center justify-center px-12 py-24">
        ...
        >
          ...
          <div className="relative rounded-[36px] bg-gradient-to-br from-[#1a1d26]/80 via-[#12141a]/90 to-[#1a1d26]/80 border border-white/[0.06] backdrop-blur-2xl overflow-hidden shadow-[0_24px_80px_rgba(0,0,0,0.5)]">
            ...
            <div className="relative px-16 py-20">
              ...
              <div className="max-w-[720px]">
                <h1 className="text-[56px] leading-[1.1] tracking-[-0.03em] mb-6">
                ...
                {/* Subtitle */}
                <p className="text-[15px] text-muted-foreground/70 font-light tracking-tight mb-10 leading-relaxed">
                ...
                <div className="flex items-center gap-4 mb-16">
                  ...
                  <span className="text-[13px] text-muted-foreground/40 font-light">or</span>
        ...
        <div className="grid grid-cols-12 gap-6">
          ...
          >
            <Link to="/advisory" className="group block">
              <div className="h-[420px] rounded-[28px] bg-gradient-to-br from-[#1a1d26]/60 via-[#12141a]/70 to-[#1a1d26]/60 border border-white/[0.08] p-10 hover:border-white/[0.12] transition-all duration-500 hover:shadow-[0_16px_48px_rgba(0,0,0,0.4)]">
          ...
          >
            <Link to="/fund" className="group block">
              <div className="h-[420px] rounded-[28px] bg-gradient-to-br from-[#1a1d26]/50 via-[#12141a]/60 to-[#1a1d26]/50 border border-white/[0.06] p-10 hover:border-white/[0.1] transition-all duration-500">
                <div className="flex flex-col justify-between h-full">
                  <div>
                    <div className="inline-flex items-center gap-2 mb-4">
          ...
          >
            <div className="rounded-[24px] bg-gradient-to-br from-[#1a1d26]/30 via-[#12141a]/40 to-[#1a1d26]/30 border border-white/[0.04] p-8 hover:border-white/[0.06] transition-all duration-500">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-8">
                  ...
                  <h3 className="text-[24px] font-light tracking-tight text-foreground/70">
                    Build
                  </h3>
      ...
      <section className="max-w-[1200px] mx-auto px-12 py-16">
        ...
        >
          <div className="flex items-start justify-between mb-8">
            <div>
              <h3 className="text-[32px] font-light tracking-tight text-foreground/90 mb-3">
                Trust Center
              </h3>
      ...
      {/* Disclaimer */}
      <section className="max-w-[1200px] mx-auto px-12 py-8 mb-16">
        <p className="text-[11px] text-muted-foreground/40 font-light text-center leading-relaxed">
